...
from functions import session_check

in_file = "/home/usha/python/log/result.txt"
log_file = "/home/usha/python/log/link_refs.log"
cited_ref_file = "/home/usha/python/log/cited_ref.txt"
citing_ref_file = "/home/usha/python/log/citing_ref.txt"
cited_ref_out = open(cited_ref_file, "a")
citing_ref_out = open(citing_ref_file, "a")
log = open(log_file, "w")
for line in file(in_file, "r"):
    ...
    print(a, file=log)
    print("\n===========================\n", file=log)
    print("\nCited Ref Cnt: %s" % (cited_ref_cnt))
    print("\nCiting Ref Cnt: %s" % (citing_ref_cnt))
